...
public class RecurringTest {
	...
	public void testF() throws Exception{
		TaskObject task = new TaskObject("buy eggs", LocalDateTime.of(2016, 10, 13, 15, 00), "deadline", "incomplete", 6);
		task.setIsRecurring(true);
		Interval interval = new Interval("WEEKLY", 1, 5, "");
		task.setInterval(interval);
	...
	public void testI() throws Exception{
		TaskObject task = new TaskObject("buy lunch", LocalDateTime.of(2016, 3, 16, 15, 00), "deadline", "incomplete", 9);
		task.setIsRecurring(true);
	...
	public void testJ() throws Exception {
		TaskObject task = new TaskObject("cs lecture", LocalDateTime.of(2016, 04, 01, 16, 00),
				LocalDateTime.of(2016, 04, 01, 18, 00), "event", "incomplete", 2);
		task.setIsRecurring(true);
